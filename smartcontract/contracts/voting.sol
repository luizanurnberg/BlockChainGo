...
contract VotingSystem {
    ...
    // Vote for a proposal
    function vote(uint256 proposalId) public returns (bool, bool, uint256) {
        ...
        return (sender.isRegistered, sender.hasVoted, sender.votedProposalId);
    }
    ...
    function getVoter() public view returns (bool, bool, uint256) {
        Voter storage sender = voters[msg.sender];
        return (sender.isRegistered, sender.hasVoted, sender.votedProposalId);
    }
}